...
#' @param drop_multistate logical vector. If TRUE,the multistate parent features of the binarised features are kept alongside the binarised features. If FALSE, they are dropped from the resulting data-frame, only binary and binarised features remain
